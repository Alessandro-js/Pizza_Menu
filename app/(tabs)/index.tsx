...
const LOGO_IMAGE = 'https://lh3.googleusercontent.com/aida-public/AB6AXuAAg9uOCvJMVEeTkFXPQu7felJxFTPDAeZP-VeLxsj19AXaWPsPys9twPClfdsPvr1PBFIpcIArdAlMgB5p2RSdL3CKmz0tsX6pEu5ow6vSLAfIwvMTIIhh3nhT8IP11JDifN3PM5cLGtdbTEqr8EgJofax1hi3ByrPWhHtbcLwPKqgycTOkv_x-QHeUpUeT_rHtHZb7ZDTJ9xIw5NIr3MsRGLTWMnFHGXpa10f5HGmrpZ-gKWmFQAmM6T10HUtrxmc5Tpp79aVoA';

const PIZZA1 = 'https://lh3.googleusercontent.com/aida-public/AB6AXuBcYy0tTjonXSPxNCyF0uMeldRhw8zuroNEEZzilgPa3lnrYDGVvLdMRjllkYRuNfFSo7RDP-m8LZyrEqK5Nll3mDe1-IzFKnhkcil4pFgyWexlPiVPpQD7qFwpvVE-CsBe5VH7VsbzLVP3-EDljZebC9T2qMUGoo4vxRIK6Cl_jA3rCKKo8AJX1SmOXYiFs_atLWy-2UIiJpVl2_RuJEV75dz3XiqJFSkZ9CEnHDmHiz_C-9MgjrK5tkmPfG4rqXgwuE6ly6wo4A';
const PIZZA2 = 'https://lh3.googleusercontent.com/aida-public/AB6AXuARvfLFL6Iqn1KbZhq32zALfRs1IrvwDrUHou1fAk8JOeRcbHMRDnBTkF_UMGWpEu_rESz2DXZdEuFAQNMmKmAM9ikkQwC8-WnfwkaVE-3r-91asm2RJl2fB6-8Ef5WAVSxMbPAP6ZXkoIlUJjsFkDXZHcSVKOHrAs2GwRUeRlL7KMMjdc1HkbPhoAnAmv26m-cclV5h-Mo9I3Ld_cvL37cNNv9JVNc6SpPPXI4Kzsz1-YuGEM2KHHal4RIPOjBBL5W3Zo5LffJjw';
const ORDER1 = 'https://lh3.googleusercontent.com/aida-public/AB6AXuDHUajNyv7s4CEKPOZatyDSmIJBiq1UpqVYhxCwlmRGpKC18sUQjLDbJdFjYvntUWVEtL5fMllTdfb5_BCOSI8PLPSZO7LO03J11yfH08y_Vhbr1JQ_WKBCN955-TUWHAat_BV-DTYp5nF_EuYGHpUiwn-8m45zoUB9kpBlROApznXwjxQbdKVaI3MXZ3FtsMecCpZ2NhjZE2xl_b7L0RBzj9H69B7Ph7tZYY2MNBS8T-LEcwBvHb8-0ZajNf26wZscRLM5Iemj_w';
const ORDER2 = 'https://lh3.googleusercontent.com/aida-public/AB6AXuCE5KzITUg5jP-fd2AOkfLoE-Ng-SPAOvkFDrVddyepldjPRmTuImZDxLZNSrN-x2zoiCeFEnQnhSniurpqC6kUlfc9CaCFWcV3wvZfab_1YaIksaLnslFiqVo3wxAcxSFd7biJbfcdONpr5caMFOfWPXHcG1iZ6saT508ODxHIshUeACYAcICLyyA5dNOHQ0vJ53-LanutxjkrFZch9BRrUOAjlf29bOPYRWfOZf4A1xuVDme7uDL4HOowIr_L87X-fSpdSVS6iA';
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        >
          {CATEGORIES.map((cat, i) => (
            <TouchableOpacity
              key={i}
              style={[styles.categoryItem, cat.active && styles.categoryItemActive]}
            >
              <View style={[styles.categoryIconBox, cat.active && styles.categoryIconBoxActive]}>
                <Text style={styles.categoryIcon}>{cat.icon}</Text>
              </View>
              <Text style={[styles.categoryLabel, cat.active && styles.categoryLabelActive]}>
                {cat.label}
              </Text>
            </TouchableOpacity>
          ))}
